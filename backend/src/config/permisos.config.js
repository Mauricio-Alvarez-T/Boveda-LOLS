...
const MAESTRO_PERMISOS = [
    ...
    ['inventario.transferencias.cancelar',     'Inventario', 'Cancelar Transferencia',      'Cancelar una transferencia en estado pendiente, aprobada o en tránsito. El solicitante puede cancelar su propia TRF sin este permiso.', 18],
