...
const MAESTRO_PERMISOS = [
    ...
    ['asistencia.sabados_extra.crear',         'Asistencia', 'Crear Citación Sábado',       'Crear y editar citaciones de trabajo extraordinario en sábado', 13],
    ['asistencia.sabados_extra.registrar',     'Asistencia', 'Registrar Asistencia Sábado', 'Marcar asistencia y horas trabajadas el sábado', 14],
    ['asistencia.sabados_extra.enviar_whatsapp','Asistencia','Enviar Sábado por WhatsApp',  'Compartir citación o asistencia de sábado por WhatsApp', 15],
