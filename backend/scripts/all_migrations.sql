...
-- =============================================
-- Migración 023: Imagen en items_inventario
-- =============================================
ALTER TABLE items_inventario
ADD COLUMN IF NOT EXISTS imagen_url VARCHAR(500) NULL DEFAULT NULL AFTER unidad;

-- =============================================
-- Migración 024: Discrepancias de Transferencias
-- Registra cuando cantidad_recibida ≠ cantidad_enviada al recibir.
-- =============================================
