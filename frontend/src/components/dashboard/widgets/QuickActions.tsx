...
const ALL_ACTIONS: QuickAction[] = [
    { label: 'Trabajadores (Gestiones)', icon: Users, route: '/consultas?tab=trabajadores', requiredModule: 'trabajadores', requiredAction: 'puede_ver' },
    { label: 'Registrar Asistencia', icon: CheckSquare, route: '/asistencia', requiredModule: 'asistencia', requiredAction: 'puede_crear' },
    { label: 'Exportar Reportes', icon: FileText, route: '/consultas?tab=trabajadores', requiredModule: 'fiscalizacion', requiredAction: 'puede_ver' },
