...
import { FileText, Plus, Eye, Trash2, Loader2, X } from 'lucide-react';
...
const CATEGORIAS: { value: VehiculoDocumentoCategoria; label: string }[] = [
    ...
    { value: 'primera_inscripcion', label: 'Primera inscripción' },
...
export const VehiculoDocumentos: React.FC<Props> = ({ vehiculoId }) => {
    ...
    const [categoria, setCategoria] = useState<VehiculoDocumentoCategoria>('seguro_terceros');
    ...
    const handleView = async (doc: VehiculoDocumento) => {
        ...
        try {
            ...
            // Liberar memoria después de un momento (la pestaña ya cargó el blob)
